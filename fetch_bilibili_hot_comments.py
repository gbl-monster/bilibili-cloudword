...
comment_url = 'https://api.bilibili.com/x/v2/reply/wbi/main?oid=113185977798555&type=1&mode=3&pagination_str=%7B%22offset%22:%22%22%7D&plat=1&seek_rpid=&web_location=1315875&w_rid=aca3663b41afbee00ae014950285cfcc&wts=1735360694'
...
for index in replies:
    with open('hot_comments.txt', mode='a', encoding='utf-8') as f:
        comment = index['content']['message']
        f.write(comment)
        f.write('\n')
        print(comment)